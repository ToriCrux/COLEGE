    ...
    public class CreateModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            catch (DbUpdateException ex)
            {
                ...
                {
                    ModelState.AddModelError(string.Empty, "Já existe um Mangá com esse código!");
                    return Page();
                }

                ModelState.AddModelError(string.Empty, "Ocorreu um erro ao salvar o Mangá! Por favor, tente novamente.");
                return Page();
            }
        }
    }
