    ...
    public partial class first : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Mangas", x => x.Codl);
                    table.ForeignKey(
                        name: "FK_Mangas_Assuntos_CodAs",
                        column: x => x.CodAs,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MangaCodl = table.Column<int>(name: "Manga_Codl", type: "int", nullable: false),
                    AutorCodAu = table.Column<int>(name: "Autor_CodAu", type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Manga_Autor", x => new { x.MangaCodl, x.AutorCodAu });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Manga_Autor_Mangas_Manga_Codl",
                        column: x => x.MangaCodl,
